...
import { IOrder } from 'app/shared/model/product/order.model';
...
export class OrderService {
  public resourceUrl = SERVER_API_URL + 'services/product/api/orders';
  ...
  protected convertDateFromClient(order: IOrder): IOrder {
    const copy: IOrder = Object.assign({}, order, {
      createdDate: order.createdDate && order.createdDate.isValid() ? order.createdDate.format(DATE_FORMAT) : undefined,
    });
    return copy;
  }
