...
import { OrderUpdateComponent } from 'app/entities/product/order/order-update.component';
import { OrderService } from 'app/entities/product/order/order.service';
import { Order } from 'app/shared/model/product/order.model';
